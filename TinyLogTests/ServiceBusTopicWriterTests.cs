...
{
    [TestClass]
    public class ServiceBusTopicWriterTests : ServiceBusQueueBaseClass
    {
        public ServiceBusTopicWriterTests()
            :base("tinylogservicebustopic.txt","tinylogtopic")
        {
        ...
        [TestMethod]
        [TestCategory("Local")]
        public async Task ServiceBusTopicWriterTests_Write100Exceptions()
        {
            int num = 0;
            for (int i = 0; i < 100; i++)
            {
        ...
        [TestMethod]
        [TestCategory("Local")]
        public async Task ServiceBusTopicWriterTests_Write100LogEntries()
        {
            int num = 0;
            for (int i = 0; i < 100; i++)
            {
