...
{
    [TestClass]
    public class ServiceBusQueueWriterTests : ServiceBusQueueBaseClass
    {
        public ServiceBusQueueWriterTests()
        {
        ...
        [TestMethod]
        [TestCategory("Local")]
        public async Task ServiceBusQueueWriterTests_Write100Exceptions()
        {
            int num = 0;
            for (int i = 0; i < 100; i++)
            {
        ...
        [TestMethod]
        [TestCategory("Local")]
        public async Task ServiceBusQueueWriterTests_Write100LogEntries()
        {
            int num = 0;
            for (int i = 0; i < 100; i++)
            {
