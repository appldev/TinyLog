...
{
    [TestClass]
    public class StorageQueueWriterTests : AzureStorageBaseClass
    {
        public StorageQueueWriterTests()
        {
        ...
        [TestMethod]
        [TestCategory("Local")]
        public async Task StorageQueueWriterTests_Write100Exceptions()
        {
            int num = 0;
            for (int i = 0; i < 100; i++)
            {
        ...
        [TestMethod]
        [TestCategory("Local")]
        public async Task StorageQueueWriterTests_Write100LogEntries()
        {
            int num = 0;
            for (int i = 0; i < 100; i++)
            {
                ...
                List<Company> list = LogHelpers.GetCompanies(random.Next(1, 5), random.Next(1, 3));
